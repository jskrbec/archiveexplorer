<%@page import="jsppages.JspKeyword"%>
...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    <%
        ...
        String keyword = request.getParameter("kw").replace("_", " ");
        String id = request.getParameter("id");
        
        JspKeyword pageInfo = new JspKeyword(id,conn);
    %>
<title><%=keyword%></title>
</head>
<body>
    <div id="frameDiv" style="float:none;width:1001px;margin-left:auto;margin-right:auto;">
        ...
        <div id="nameDiv" style="vertical-align: top; float: left; width: 100%; height: 50px; border: 0px;color: #3634A6;background-color: #FFFFFF;margin-top: 1px;">
            <sub>Keyword</sub>
            <h2 style="margin: 0; margin-left: 20px;"><%=keyword%></h2>
        </div>
        ...
        <div id="rightDiv"
            ...
            if (!pageInfo.getAuthors().isEmpty())
            {
                ...
                {
                    %><li><span id="<%=a.getId()%>" onClick="document.location='author.jsp?&id=<%=a.getId()%>'" style="cursor: pointer"><%=a.getName()%></span>
                </li>
                <%
                }
                %>
